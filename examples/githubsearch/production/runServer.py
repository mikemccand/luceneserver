...
class RunServer:
  ...
  def __init__(self, port, path, eachLine=None):
    ...
    cmd = '%s -Xms%s -Xmx%s -Xss228k -cp "../luceneserver/lib/*" org.apache.lucene.server.Server -maxHTTPThreadCount 2 -ipPort localhost:%s -stateDir %s' % (localconstants.JAVA_EXE, HEAP, HEAP, port, localconstants.GLOBAL_STATE_PATH)
